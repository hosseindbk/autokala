@extends('master-main')
@section('title')
<title>فرم افزودن برند قطعات</title>
                                        ...
                                        <div class="row row-sm">
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="card-body">
                                                                <div class="text-center"><h3 class="main-content-label text-center text-info">ثبت برند جدید قطعات </h3></div>
                                                            </div>
                                                            <form action="{{ route('brand-create')}}" method="POST" enctype="multipart/form-data">
                                                                <div class="row row-sm">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <p class="mg-b-10">تصویر لوگو برند</p>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                    <div class="form-group">
                                                                            <p class="mg-b-10">واتس اپ، تلگرام و..</p>
                                                                    ...
                                                                    <div class="col-md-12" >
                                                                        <h4 style="border-bottom: 2px solid #ff3d00;padding: 10px;width: 350px;margin-top: 20px;">موقعیت</h4>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="address" id="" cols="30" rows="1" class="form-control" placeholder="آدرس را وارد کنید"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                        ...
                        <div class="profile-content">
                            <div class="profile-stats">
                                <div class="profile-address">
                                    <div class="middle-container">
                                        <div class="col-md-12" >
                                            <h5 style="border-bottom: 2px solid #ff3d00;padding: 10px;width: 450px;margin-top: 20px;">معرفی نمایندگی های فروش شما</h5>
                                        </div>
                                        <div class="col-md-12">
                                            <div style="background-color: #0ab2e699; border-radius: 15px; padding: 20px; margin: 20px 0px 40px 0px;">
                                                <ul>
                                                    <li><p>در این قسمت شما می توانید هر یک از فروشگاه های موجود در سایت را به عنوان نمایندگی فروش محصولات برند خود معرفی نمایید.</p></li>
                                                    <li><p>می توانید فروشگاهی را که قبلا به عنوان نمایندگی خود معرفی کرده اید از لیست زیر حذف نمایید.</p></li>
                                                    <li><p>پیش از انجام ثبت نهایی اطلاعات فروشگاه انتخاب شده خود را کنترل نموده و از انتخاب صحیح فروشگاه مورد نظر اطمینان حاصل نمایید.</p></li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <h3 class="text-center mb-1">
                                                <span class="btn-outline-info">اطلاعات برندهای ثبت شده توسط شما</span>
                                            </h3>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table" id="example1">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="wd-10p"> نام برند فارسی </th>
                                                    <th class="wd-10p"> نام برند انگلیسی </th>
                                                ...
                                                @foreach($brandcreate as $brand)
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('brand-edit' , $brand->id) }}"  class="btn btn-outline-primary btn-xs">
