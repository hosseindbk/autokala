                                                    ...
                                                    @if(Auth::user()->type_id == 1)
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                @if($varity = 0 )
                                                                    <input type="file" name="image1"    @foreach($products as $product)  value="{{$product->image}}"  data-default-file="{{url($product->image)}}" @endforeach class="dropify" data-height="200">
                                                                    <input type="hidden" name="image1"  @foreach($products as $product)  value="{{$product->image}}" @endforeach>
                                                                @elseif($varity = 1)
