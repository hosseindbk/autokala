                            ...
                            <div class="archive-header">
                                ...
                                <div class="nav-sort-tabs-res">
                                    ...
                                    <div class="float-left">
                                        <a href="{{url('offer')}}" target="_blank" class="btn btn-outline-danger" data-toggle="tooltip" data-placement="right" title="در صورت تمایل به درج آگهی کالای خود با کلیک روی این کلید ابتدا ثبت نام و سپس آگهی خود را تکمیل نمایید">ثبت آگهی</a>
                                    </div>
                                </div>
                            </div>
