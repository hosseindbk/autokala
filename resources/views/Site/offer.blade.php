                                                ...
                                                @if(Auth::user()->type_id == 1)
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="description" id="editor1" placeholder=" شرح آگهی را وارد کنید">شرح آگهی</textarea>
                                                            <style>
                                                                .ck-editor{
                                                                    direction: rtl;
                                                                    text-align: right;
...
{{--                                                            </select>--}}
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <p class="mg-b-10">شرح آگهی</p>
                                                            <textarea name="description" id="editor2" placeholder=" شرح آگهی را وارد کنید">شرح آگهی</textarea>
                                                            <style>
                                                                .ck-editor{
                                                                    direction: rtl;
                                                                    text-align: right;
