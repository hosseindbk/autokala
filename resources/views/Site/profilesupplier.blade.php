                            ...
                            <div class="profile-stats">
                                <div class="profile-address">
                                    <div class="middle-container">
                                        <div class="card-body">
                                            <div class="text-center"><h3 class="main-content-label text-center text-info">ثبت مشخصات فروشگاه / شرکت </h3></div>
                                        </div>
                                        <form action="{{ route('profilesupplierstore')}}" method="POST" enctype="multipart/form-data">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="phone" pattern="^0\d{2,3}-\d{8}$" placeholder="021-22334455"
