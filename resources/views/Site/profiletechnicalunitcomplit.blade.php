@extends('master-main')
@section('title')
    <title>تکمیل پروفایل فروشگاه</title>
                                ...
                                <div class="profile-stats">
                                    <div class="profile-address">
                                        <div class="middle-container">
                                            ...
                                            <div class="col-md-12" >
                                                <h5 style="border-bottom: 2px solid #ff3d00;padding: 10px;width: 450px;margin-top: 20px;">حوزه فعالیت (انواع خودرو و خدمات قابل ارائه)</h5>
                                            </div>
                                            <div class="col-md-12">
                                                <div style="background-color: #0ab2e699; border-radius: 15px; padding: 20px; margin: 20px 0px 40px 0px;">
                                                    <ul>
                                                        <li><p>* ابتدا خودرو و مدل آن و سپس خدمات مربوط به آن خودرو راانتخاب نمایید و در انتها بر روی کلید ثبت خودرو کلیک نمایید </p></li>
                                                        <li><p>* چنانچه روی خودروهای متعدد و یا نوع خدمات متنوع از یک خودرو فعالیت دارید می توانید ردیف های بیشتری به جدول زیر اضافه نمایید.</p></li>
                                                        <li><p>* اطلاعات وارد شده در این قسمت ، در جستجوی کاربران و دسترسی به تعمیرگاه شما تاثیر زیادی دارد، در ورود اطلاعات و اطمینان از صحت آن دقت نمایید.</p></li>
