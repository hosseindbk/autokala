@extends('Admin.admin')
@section('title')
    <title> ایجاد واحد خدمات فنی </title>
        ...
        <div class="container-fluid">
            <div class="inner-body">
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">مدیریت واحد خدمات فنی</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('admin/panel')}}">صفحه اصلی</a></li>
                            <li class="breadcrumb-item"><a href="{{url('admin/technicalunits')}}">مدیریت واحد خدمات فنی</a></li>
                            <li class="breadcrumb-item active" aria-current="page">ایجاد واحد خدمات فنی</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-sm">
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                <div>
                                    <h3 class="text-center mb-5"><span class="badge badge-light">ورود اطلاعات واحد خدمات فنی</span></h3>
                                </div>
                                    <form action="{{ route('technicalunits.store')}}" method="POST" enctype="multipart/form-data">
                                    <div class="row row-sm">
                                        {{csrf_field()}}
                                        <div class="col-md-12">
                                            @include('error')
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" data-required="1" placeholder="نام واحد خدمات فنی را وارد کنید" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mobile" data-required="1" placeholder="همراه را وارد کنید" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <p class="mg-b-10">شماره همراه2</p>
                                                <input type="text" name="mobile2" data-required="1" placeholder="همراه را وارد کنید" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" data-required="1" placeholder="تلفن را وارد کنید" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <p class="mg-b-10">تلفن ثابت2</p>
                                                <input type="text" name="phone2" data-required="1" placeholder="تلفن را وارد کنید" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <p class="mg-b-10">تلفن ثابت3</p>
                                                <input type="text" name="phone3" data-required="1" placeholder="تلفن را وارد کنید" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" id="" cols="30" data-required="1" rows="5" class="form-control" placeholder="ادرس واحد خدمات فنی را وارد کنید"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
