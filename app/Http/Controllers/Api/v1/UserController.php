    ...
    public function profile(){
        if (Auth::check()) {
            ...
            $brandnames = Offer::
                ...
                ->select('offers.id' , 'offers.buyorsell' , 'offers.title_offer', 'offers.product_name', 'offers.unicode_product', 'offers.brand_name as brand_name' ,'brands.title_fa as brand' , 'offers.brand_id as brand_id'
