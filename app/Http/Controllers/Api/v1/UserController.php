    ...
    public function profile(){
        if (Auth::check()) {
            ...
            $brandnames = Offer::
                ...
                ->select('offers.id' , 'offers.buyorsell' , 'offers.title_offer', 'offers.product_name', 'offers.unicode_product', 'offers.brand_name as brand_name', 'offers.brand_id as brand_id'
