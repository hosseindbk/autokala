...
class IndexController extends Controller
{
    public function index(){
        ...
        return Response::json(['citis' => $citis , 'state'=>$state , 'offer'=>$offers , 'brand'=>$brands, 'menus'=>$menus
                               , 'technicalunits'=>$technicalunits  , 'suppliers'=>$suppliers , 'orginal_slides'=>$orginal_slides ]);
