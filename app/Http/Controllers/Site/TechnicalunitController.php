...
//        }
        ...
        $clicktechnicals    = Technical_unit::filter()->technicalsearch($keywords)->whereStatus(4)->orderBy('click')->paginate(16);
        $goodtechnicals     = Technical_unit::filter()->technicalsearch($keywords)->whereStatus(4)->orderBy('id' , 'DESC')->paginate(16);
        $oldtechnicals      = Technical_unit::filter()->technicalsearch($keywords)->whereStatus(4)->orderBy('id')->paginate(16);
        $count              = Technical_unit::filter()->technicalsearch($keywords)->whereStatus(4)->count();
