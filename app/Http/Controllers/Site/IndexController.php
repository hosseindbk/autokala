...
class IndexController extends Controller
{
    ...
    public function index(){
        ...
        $left_top_slides    = Slide::select('id' ,'link' , 'image', 'title')->whereStatus(4)->wherePosition(2)->limit(1)->get();
        $left_bottom_slides = Slide::select('id' ,'link' , 'image', 'title')->whereStatus(4)->wherePosition(3)->limit(1)->get();
