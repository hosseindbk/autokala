...
class IndexController extends Controller
{
    ...
    public function company($slug)
    {
        ...
        ->select('suppliers.id' ,'suppliers.logo' ,'suppliers.title','suppliers.slide1','suppliers.banner','suppliers.slide2','suppliers.slide3' ,'suppliers.description' ,'suppliers.lat' ,'suppliers.lng' ,
